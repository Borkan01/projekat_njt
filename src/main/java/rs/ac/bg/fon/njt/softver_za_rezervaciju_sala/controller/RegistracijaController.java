...
public class RegistracijaController {
    ...
    public RegistracijaController(KorisnikImpl korisnikImpl,RegistracijaImpl registracijaImpl
            ,ZaposleniImpl zaposleniImpl,EmailService emailService) {
    ...
    public String handleRegistration(@RequestParam String email) {
        ...
        if(zaposleni==null){
            return "register/employee_not_exist";
        }
        else{
            try {
                Korisnik korisnik = korisnikImpl.vratiKorisnikaPoOsobaId(zaposleni.getId());
                if(korisnik!=null){
                    ...
                    Registracija registracija = new Registracija(token, zaposleni);
